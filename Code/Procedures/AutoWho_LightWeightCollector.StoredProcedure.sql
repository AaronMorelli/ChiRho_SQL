...
*****
*****	FILE NAME: AutoWho_LightweightCollector.StoredProcedure.sql
*****
*****	PROCEDURE NAME: AutoWho_LightweightCollector
*****
...
GO
CREATE PROCEDURE @@CHIRHO_SCHEMA_OBJECTS@@.AutoWho_LightWeightCollector
/*
	OUTSTANDING ISSUES: None at this time.

To Execute
------------------------
EXEC @@CHIRHO_SCHEMA_OBJECTS@@.AutoWho_LightWeightCollector
*/
AS
BEGIN
	...
	BEGIN TRY
		...
		INSERT INTO @@CHIRHO_SCHEMA_OBJECTS@@.AutoWho_LightweightSessions
		(
		...
		SELECT 
			...
			--TODO: ditto... this col is not in 2008. Do I need it?
		...
		INSERT INTO @@CHIRHO_SCHEMA_OBJECTS@@.AutoWho_LightweightTasks
		(
		...
		INSERT INTO @@CHIRHO_SCHEMA_OBJECTS@@.AutoWho_LightweightTrans
		(

...
*****
*****	FILE NAME: AutoWho_SARException.Table.sql
*****
*****	TABLE NAME: AutoWho_SARException
*****
...
*****
*****	PURPOSE: Holds raw sessions/requests data when @@CHIRHO_SCHEMA_OBJECTS@@.AutoWho_Collector
*****	encounters an exception of some kind, to aid in troubleshooting.
******/SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE @@CHIRHO_SCHEMA_OBJECTS@@.AutoWho_SARException(

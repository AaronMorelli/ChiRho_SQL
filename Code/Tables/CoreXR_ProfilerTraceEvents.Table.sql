...
GO
CREATE TABLE @@CHIRHO_SCHEMA_OBJECTS@@.CoreXR_ProfilerTraceEvents(
...
GO
CREATE UNIQUE NONCLUSTERED INDEX [AKProfileTraceEvents] ON @@CHIRHO_SCHEMA_OBJECTS@@.CoreXR_ProfilerTraceEvents
(
	[EventGroup] ASC,
	[event_name] ASC,
	[category_name] ASC
...
GO
ALTER TABLE @@CHIRHO_SCHEMA_OBJECTS@@.CoreXR_ProfilerTraceEvents  WITH CHECK ADD  CONSTRAINT [CK_ProfilerTraceEvents_isEnabled] CHECK  (([isEnabled]=N'N' OR [isEnabled]=N'Y'))
GO
ALTER TABLE @@CHIRHO_SCHEMA_OBJECTS@@.CoreXR_ProfilerTraceEvents CHECK CONSTRAINT [CK_ProfilerTraceEvents_isEnabled]
GO

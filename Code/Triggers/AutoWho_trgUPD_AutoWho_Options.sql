...
*****
*****	FILE NAME: AutoWho_trgUPD_AutoWho_Options.sql
*****
*****	TRIGGER NAME: AutoWho_trgUPD_AutoWho_Options
*****
...
GO
CREATE TRIGGER @@CHIRHO_SCHEMA_OBJECTS@@.AutoWho_trgUPD_AutoWho_Options ON @@CHIRHO_SCHEMA_OBJECTS@@.AutoWho_Options
FOR UPDATE
AS
BEGIN
    INSERT INTO @@CHIRHO_SCHEMA_OBJECTS@@.AutoWho_Options_History (
        ...
        BlockingChainThreshold, BlockingChainDepth, TranDetailsThreshold, MediumDurationThreshold, 
        HighDurationThreshold, BatchDurationThreshold, LongTransactionThreshold, 
        ...
        Retention_ActiveBatch, Retention_CaptureTimes, DebugSpeed, ThresholdFilterRefresh, 
        SaveBadDims, Enable8666, ResolvePageLatches, ResolveLockWaits, PurgeUnextractedData,
        HistoryInsertDate,
